...
const amount1=()=>{
  setAmount(quotationData.subtotal+quotationData.taxAmount);
   setAmountInWords(converter.toWords(quotationData.subtotal+quotationData.taxAmount));
   console.log("Amount in Words:", converter.toWords(quotationData.subtotal+quotationData.taxAmount));
      ...
      <div ref={printRef} className="max-w-4xl mx-auto bg-white shadow-lg rounded-2xl print-container">
        ...
        <div className="p-4 sm:p-6 md:p-8">
          ...
          <div className="mb-6">
            ...
            <p className="font-semibold text-gray-800 mb-1 text-sm sm:text-base">Sanjeev Kumar</p>
